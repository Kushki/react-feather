...
const Package = forwardRef(({ color = 'currentColor', size = 24, ...rest }, ref) => {
  return (
    ...
    >
      ...
      />
      <path
        d="M2.31995 6.16L11.9999 11L21.6799 6.16"
        stroke="#46525C"
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
