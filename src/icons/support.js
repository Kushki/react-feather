...
const Support = forwardRef(({ color = 'currentColor', size = 24, ...rest }, ref) => {
  return (
    <svg
      ...
      {...rest}
    >
      <path d="M4 13V8.6C4 6.84957 4.84285 5.17084 6.34315 3.9331C7.84344 2.69536 9.87827 2 12 2C14.1217 2 16.1566 2.69536 17.6569 3.9331C19.1571 5.17084 20 6.84957 20 8.6V13" />
      ...
      <path d="M19.9897 15C20.1377 17.3333 18.7469 22 12 22" />
    </svg>
  );
});
